...
record_location: "C:/Users/acer/Downloads/Documents/HK 231/Computer Architecture/Assignment/records.txt"
record: .asciiz "( , )"
record_player1_atk: .asciiz "Player1 shot at: "
record_player2_atk: .asciiz "Player2 shot at: "
record_player1_win: .asciiz "\nPlayer1 won!"
record_player2_win: .asciiz "\nPlayer2 won!"
...
player2_grid:	.word 0,0,0,0,0,0,0
                .word 0,0,0,0,0,0,0 
                .word 0,0,0,0,0,0,0 
                .word 0,0,0,0,0,0,0 
                .word 0,0,0,0,0,0,0 
...
main:
    ...
    # open file to record attacks
    li $v0, 13
    la $a0, record_location
    li $a1, 1
    syscall
    move $s7, $v0		# s7 hold the record location
...
record_atk: # void record_atk(<player> $s6, <cord_x> $t0, <cord_y> $t1, <hit> $v0)
    addi $sp, $sp, -16
    sw $t0, 0($sp)
    sw $t1, 4($sp)
    sw $s0, 8($sp)
